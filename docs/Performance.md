...
**Verified against:** app version 0.19.14, `master`, 2026-09-13 — the query
sections re-measured end to end on a seeded instance (22,642 posts, 65,014
recipient rows, 916 follows, 435 cached actors) after the read-path wave below,
and the bundle sizes measured from `npm run build` on this version.
