...
and, since 0.26.58, the trending section that used to sit above it as a caption
...
It asked `only_media` alone until 0.26.58, which is Mastodon's question — *does
