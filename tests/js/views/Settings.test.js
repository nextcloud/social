...
describe('Settings', () => {
	...
	it('is a page of sections rather than a page about shortcuts', async () => {
		...
		expect(wrapper.findAll('.settings__section-heading').map((h) => h.text()))
			.toEqual(['Your account', 'Featured hashtags', 'Lists', 'Filtered words', 'Keyboard shortcuts', 'Scheduled posts', 'Portfolio', 'Archived posts', 'Waiting to be looked at', 'Looking back', 'Authorized apps', 'Migration'])
	})
