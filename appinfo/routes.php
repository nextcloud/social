...
return [
	'routes' => [
		...
		['name' => 'AdminApi#measures', 'url' => '/api/v1/admin/measures', 'verb' => 'POST'],
		['name' => 'AdminApi#dimensions', 'url' => '/api/v1/admin/dimensions', 'verb' => 'POST'],
		['name' => 'AdminApi#retention', 'url' => '/api/v1/admin/retention', 'verb' => 'POST'],
		...
		['name' => 'AdminApi#trendTags', 'url' => '/api/v1/admin/trends/tags', 'verb' => 'GET'],
		['name' => 'AdminApi#trendStatuses', 'url' => '/api/v1/admin/trends/statuses', 'verb' => 'GET'],
		['name' => 'AdminApi#trendLinks', 'url' => '/api/v1/admin/trends/links', 'verb' => 'GET'],
