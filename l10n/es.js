OC.L10N.register(
    ...
    "{account} posted a status" : "{account} ha publicado un estado",
    "{account} boosted your post" : "{account} recomendó su publicación",
    "{account} started to follow you" : "{account} comenzó a seguirte",
    "{account} requested to follow you" : "{account} ha solicitado seguirte",
    "{account} liked your post" : "{account} hizo like a tu publicación",
    "{account} ended the poll" : "{account} terminó la votación",
    "{account} edited a status" : "{account} editó un estado",
    "{account} signed up" : "{account} se unió ",
    "{account} filed a report" : "{account} remitió un reporte",
