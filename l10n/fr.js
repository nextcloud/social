OC.L10N.register(
    ...
    "{account} as ended the poll" : "{account} a min fin au sondage",
    "{account} edit a status" : "{account} édite un statut",
    "{account} signed up" : "{account} s'est inscrit",
    "{account} filled a report" : "{account} a rempli un rapport",
