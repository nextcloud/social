OC.L10N.register(
    ...
    "Social needs the .well-known automatic discovery to be properly set up. If Nextcloud is not installed in the root of the domain, it is often the case that Nextcloud cannot configure this automatically. To use Social, the administrator of this Nextcloud instance needs to manually configure the .well-known redirects:" : "Social precisa que a descoberta automática .well-known seja configurada corretamente. Se o Nextcloud não estiver instalado na raiz do domínio, é comum que o Nextcloud não consiga configurar isso automaticamente. Para usar o Social, o administrador desta instância do Nextcloud precisa configurar manualmente os redirecionamentos .well-known:",
    "Open documentation" : "Abrir documentação",
    "Social app setup" : "Configuração do aplicativo Social",
    ...
    "You have not tooted yet" : "Você ainda não criou nenhum toot",
    ...
    "Go to Social app" : "Ir para o aplicativo Social",
    "Authorization required" : "Autorização necessária",
    "{appDisplayName} would like permission to access your account. It is a third party application." : "{appDisplayName} gostaria de ter acesso à sua conta. Ele é um aplicativo de terceiro.",
    "If you do not trust it, then you should not authorize it." : "Se você não confia nele, não deve autorizá-lo.",
    "Authorize" : "Autorizar",
    "Deny" : "Negar",
    ...
    "Nextcloud becomes part of the federated social networks!" : "Nextcloud torna-se parte das redes sociais federadas!",
    "This application is currently in beta stage." : "Este aplicativo está atualmente em fase beta.",
    "We automatically created a Social account for you. Your Social ID is the same as your Federated Cloud ID:" : "Criamos automaticamente uma conta Social para você. Seu ID Social é o mesmo que seu ID de Nuvem Federada:",
