OC.L10N.register(
    ...
    "{account} posted a status" : "{account} posted a status",
    "{account} boosted your post" : "{account} boosted your post",
    "{account} started to follow you" : "{account} started to follow you",
    "{account} requested to follow you" : "{account} requested to follow you",
    "{account} liked your post" : "{account} gostou da sua postagem",
    "{account} ended the poll" : "{account} ended the poll",
    "{account} edited a status" : "{account} edited a status",
    "{account} signed up" : "{account} signed up",
    "{account} filed a report" : "{account} filed a report",
