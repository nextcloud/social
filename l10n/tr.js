OC.L10N.register(
    ...
    "{account} has posted a status" : "{account} bir durum bildirdi",
    "{account} boosted your post" : "{account} iletinizi güçlendirdi",
    "{account} started following you" : "{account} sizi takip etmeye başladı",
    "{account} requested to follow you" : "{account} sizi takip etme isteğinde bulundu",
    "{account} like you post" : "{account} iletinizi beğendi",
    "{account} as ended the poll" : "{account} anketi sona erdirdi",
    "{account} edit a status" : "{account} bir durumu düzenledi",
    "{account} signed up" : "{account} oturum açtı",
    "{account} filled a report" : "{account} bir şikayette bulundu",
