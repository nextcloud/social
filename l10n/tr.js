OC.L10N.register(
    ...
    "Post to mentioned users" : "Anılmış kullanıcılara gönder",
    ...
    "{account} mentioned you" : "{account} sizi andı",
    "{account} posted a status" : "{account} bir durum bildirdi",
    "{account} boosted your post" : "{account} iletinizi güçlendirdi",
    "{account} started to follow you" : "{account} sizi takip etmeye başladı",
    "{account} requested to follow you" : "{account} sizi takip etme isteğinde bulundu",
    "{account} liked your post" : "{account} iletinizi beğendi",
    "{account} ended the poll" : "{account} anketi sona erdirdi",
    "{account} edited a status" : "{account} bir durumu düzenledi",
    "{account} signed up" : "{account} oturum açtı",
    "{account} filed a report" : "{account} bir şikayette bulundu",
    ...
    "You have not received any notifications yet" : "Henüz size bir bildirim gönderilmemiş",
    ...
    "You have not tooted yet" : "Henüz uyarılmamışsınız",
    ...
    "Authorization required" : "İzin verilmesi gerekli",
    "{appDisplayName} would like permission to access your account. It is a third party application." : "{appDisplayName} hesabınıza erişme izni istiyor. Bu bir üçüncü taraf uygulamasıdır.",
    "If you do not trust it, then you should not authorize it." : "Uygulamaya güvenmiyorsanız izin vermemelisiniz.",
    "Authorize" : "İzin ver",
    "Deny" : "Reddet",
    ...
    "name@domain of your federation account" : "Birleşik hesabınızın ad@etkialanı bilgisi",
    "Continue" : "Sürdür",
    ...
    "Nextcloud becomes part of the federated social networks!" : "Nextcloud birleşik sosyal ağların bir parçası haline geliyor!",
    "This application is currently in beta stage." : "Bu uygulama şu anda BETA aşamasında.",
    ...
    "Post to followers only" : "Yalnızca takipçilere gönder",
    "Direct" : "Doğrudan",
    "Post to mentioned users only" : "Yalnızca anılan kullanıcılara gönder"
},
