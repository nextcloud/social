OC.L10N.register(
    ...
    "** Disclaimer: this is an ALPHA version **\n\n**🎉 Nextcloud becomes part of the federated social networks!**\n\n**🙋 Find your friends:** No matter if they use Nextcloud, 🐘 Mastodon, 🇫 Friendica, and soon ✱ Diaspora, 👹 MediaGoblin and more – you can follow them!\n\n**📜 Profile info:** No need to fill out more profiles – your info from Nextcloud will be used and extended.\n\n**👐 Own your posts:** Everything you post stays on your Nextcloud!\n\n**🕸 Open standards:** We use the established ActivityPub standard!" : "** Avviso: questa è una versione ALFA version **\n\n**🎉 Nextcloud diventa parte delle reti sociali federate!**\n\n**🙋 Trova i tuoi amici:** Non importa se utilizzano Nextcloud, 🐘 Mastodon, 🇫 Friendica, e presto ✱ Diaspora, 👹 MediaGoblin e altro – puoi seguirli!\n\n**📜 Informazioni di profilo:** Non è necessario creare più profili – le tue informazioni da Nextcloud saranno utilizzate ed estese.\n\n**👐 Possiedi i tuoi commenti:** Tutti i tuoi commenti restano sul tuo Nextcloud!\n\n**🕸 Standard aperti:** Utilizziamo lo standardizzati riconosciuto ActivityPub!",
    ".well-known/webfinger isn't properly set up!" : ".well-known/webfinger non è configurato correttamente!",
    "Social needs the .well-known automatic discovery to be properly set up. If Nextcloud is not installed in the root of the domain, it is often the case that Nextcloud can't configure this automatically. To use Social, the admin of this Nextcloud instance needs to manually configure the .well-known redirects: " : "Sociale richiede che il rilevamento automatico di .well-known sia configurato correttamente. Se Nextcloud non è installato nella radice del dominio, è spesso il caso in cui Nextcloud non può configurarlo automaticamente. Per utilizzare Sociale, l'amministratore di questa istanza di Nextcloud deve configurare manualmente le redirezioni .well-known:",
    "Open documentation" : "Apri documentazione",
    "Social app setup" : "Configurazione applicazione Sociale",
    "ActivityPub requires a fixed URL to make entries unique. Note that this can not be changed later without resetting the Social app." : "ActivityPub richiede un URL fisso per rendere le voci univoche. Nota che questo non può essere cambiato successivamente senza ripristinare l'applicazione Sociale.",
    ...
    "Error while trying to post your message: Could not find any valid recipients." : "Errore durante il tentativo di pubblicare il tuo messaggio. Impossibile trovare un destinatario valido.",
