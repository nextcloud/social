OC.L10N.register(
    ...
    "{account} has posted a status" : "{account} е публикувал статус",
    "{account} boosted your post" : "{account} е подсилил публикацията ви",
    "{account} started following you" : "{account} започна да ви следва",
    "{account} requested to follow you" : "{account} подаде заявка да ви следва",
    "{account} like you post" : "{account} харесва публикацията ви",
