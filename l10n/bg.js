OC.L10N.register(
    ...
    {
    "Social" : "Social",
    "Social notifications" : "Social известия",
    ...
    "** Disclaimer: this is an BETA version **\n\n**🎉 Nextcloud becomes part of the federated social networks!**\n\n**🙋 Find your friends:** No matter if they use Nextcloud, 🐘 Mastodon, 🇫 Friendica, and soon ✱ Diaspora, 👹 MediaGoblin and more – you can follow them!\n\n**📜 Profile info:** No need to fill out more profiles – your info from Nextcloud will be used and extended.\n\n**👐 Own your posts:** Everything you post stays on your Nextcloud!\n\n**🕸 Open standards:** We use the established ActivityPub standard!" : "** Отказ от отговорност: това е BETA версия **\n\n**🎉 Nextcloud става част от федерираните социални мрежи!**\n\n**🙋 Намери приятелите си:** Без значение дали използват Nextcloud, 🐘 Mastodon, 🇫 Friendica, а скоро и ✱ Diaspora, 👹 MediaGoblin и други - можеш да ги следваш!\n\n**📜 Информация за профила:** Не е необходимо да регистрирате още профили – информацията от вашият Nextcloud профил може да бъде използвана и допълнена.\n\n**👐 Притежавайте публикациите си:** Всичко, което публикувате, остава във вашият Nextcloud!\n\n**🕸 Отворени стандарти:** Ние използваме утвърденият стандарт ActivityPub!",
    ...
    "Change visibility" : "Промяна на видимостта",
    "Unfollow" : "Не следвай",
    "Follow" : "Последвай",
    "posts" : "Публикации",
    "following" : "последователи",
    ...
    "boosted" : "подсилено",
    "{account} mentioned you" : "{account} ви спомена",
    "{account} posted a status" : "{account} публикува статус",
    "{account} boosted your post" : "{account} е подсилил публикацията ви",
    "{account} started to follow you" : "{account} започна да ви следва",
    "{account} requested to follow you" : "{account} подаде заявка да ви следва",
    "{account} liked your post" : "{account} хареса публикацията ви",
    "{account} ended the poll" : "{account} приключи анкетата",
    "{account} edited a status" : "{account} редактира статус",
    "{account} signed up" : "{account} се регистрира",
    "{account} filed a report" : "{account} попълни отчет",
    ...
    "You have not received any notifications yet" : "Все още не сте получили никакви известия",
    ...
    "You have not tooted yet" : "Все още не сте тутвали /публикували/",
