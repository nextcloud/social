OC.L10N.register(
    ...
    "boosted" : "recomanat",
    "{account} mentioned you" : "{account} t'ha mencionat",
    "{account} posted a status" : "{account} ha publicat un estat",
    "{account} boosted your post" : "{account} ha impulsat la teva publicació",
    "{account} started to follow you" : "{account} va començar a seguir-te",
    "{account} requested to follow you" : "{account} ha sol·licitat que us segueixi",
    "{account} liked your post" : "A {account} li ha agradat la teva publicació",
    "{account} ended the poll" : "{account} ha acabat l'enquesta",
    "{account} edited a status" : "{account} ha editat un estat",
    "{account} signed up" : "{account} s'ha registrat",
    "{account} filed a report" : "{account} ha presentat un informe",
