OC.L10N.register(
    ...
    {
    "Social" : "Social",
    "Social notifications" : "Upozornění z aplikace Social",
    ...
    "{account} posted a status" : "{account} zveřejnil(a) stav",
    "{account} boosted your post" : "{account} zesílil(a) vaši zprávu",
    "{account} started to follow you" : "{account} vás začal(a) následovat",
    ...
    "{account} ended the poll" : "{account} ukončil(a) anketu",
    "{account} edited a status" : "{account} upravil(a) stav",
    "{account} signed up" : "{account} si vytvořil(a) účet",
    "{account} filed a report" : "{account} vyplnil(a) hlášení",
    ...
    "You have not received any notifications yet" : "Doposud jste neobdrželi žádná upozornění",
    ...
    "You have not tooted yet" : "Zatím jste nic nenapsali",
