OC.L10N.register(
    ...
    "Help" : "Pomoc",
    "Follow %s on Social" : "Śledź %s na Social",
    ...
    "You haven't tooted yet" : "Jeszcze nie napisałeś niczego",
    ...
    "Continue" : "Kontynuuj",
    "This step is needed as the user is probably not registered on the same server as you are. We will redirect you to your homeserver to follow this account." : "Ten krok jest potrzebny, ponieważ użytkownik prawdopodobnie nie jest zarejestrowany na tym samym serwerze, co Ty. Przekierujemy Cię do twojego serwera domowego, aby śledzić to konto.",
    "User not found" : "Nie znaleziono użytkownika",
    "Sorry, we could not find the account of {userId}" : "Nie udało się odnaleźć konta {userId}",
    "Nextcloud becomes part of the federated social networks!" : "Nextcloud staje się częścią federacyjnych sieci społecznościowych!",
    "We automatically created a Social account for you. Your Social ID is the same as your Federated Cloud ID:" : "Automatycznie utworzyliśmy dla Ciebie konto społecznościowe. Twój ID społecznościowy jest taki sam, jak ID Chmury Federacyjnej:",
