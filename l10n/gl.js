OC.L10N.register(
    ...
    "Social needs the .well-known automatic discovery to be properly set up. If Nextcloud is not installed in the root of the domain, it is often the case that Nextcloud cannot configure this automatically. To use Social, the administrator of this Nextcloud instance needs to manually configure the .well-known redirects:" : "Social precisa que o .coñecido descubrimento automático estea configurado correctamente. Se Nextcloud non está instalado na raíz do dominio, adoita ocorrer que Nextcloud non poida configuralo automaticamente. Para usar Social, o administrador desta instancia de Nextcloud debe configurar manualmente as .redireccións coñecidas:",
    ...
    "Delete" : "Eliminar",
    "Edit" : "Editar",
    "No description added" : "Non se engadiu ningunha descrición",
    "Describe for the visually impaired" : "Describir para persoas con discapacidade visual",
    "Close" : "Pechar",
    ...
    "You have not received any notifications yet" : "Aínda non recibiches ningunha notificación",
    ...
    "You have not tooted yet" : "Aínda non fixeches ningún toot",
    ...
    "Go to Social app" : "Vaia á aplicación Social",
    "Error getting Social notifications" : "Produciuse un erro ao recibir notificacións de Social",
    "No Social notifications!" : "Sen notificacións de Social!",
    "Failed to get Social notifications" : "Produciuse un erro ao recibir as notificacións de Social",
    "{account} is following you" : "{account} está a seguirte",
    "{account} liked your post" : "A {account} gustoulle a túa publicación",
    "Authorization required" : "Requírese autorización",
    "{appDisplayName} would like permission to access your account. It is a third party application." : "{appDisplayName} quere permiso para acceder á túa conta. É unha aplicación de terceiros.",
