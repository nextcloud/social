OC.L10N.register(
    ...
    "{account} has posted a status" : "{account} 張貼了狀態",
    "{account} boosted your post" : "{account} 轉嘟了您的貼文",
    "{account} started following you" : "{account} 開始跟隨您",
    "{account} requested to follow you" : "{account} 已請求跟隨您",
    "{account} like you post" : "{account} 喜歡您的貼文",
    "{account} as ended the poll" : "{account} 結束了投票",
    "{account} edit a status" : "{account} 編輯狀態",
    "{account} signed up" : "{account} 已註冊",
    "{account} filled a report" : "{account} 填寫了報告",
