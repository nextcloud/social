OC.L10N.register(
    ...
    "Finish setup" : "完成安装",
    "The Social app needs to be set up by the server administrator." : "社交应用需要管理员进行配置。",
    "Home" : "主页",
    ...
    "Posts from other people on this instance will show up here" : "在此实例上的来自其他人的帖子将在此处显示",
    ...
    "name@domain of your federation account" : "您联合账号的name@domain",
    "Continue" : "继续",
    ...
    "Since you are new to Social, start by following the official Nextcloud account so you don't miss any news" : "由于您刚来到社交应用，请先关注Nextcloud官方账号，这样您将不会错过任何新闻",
