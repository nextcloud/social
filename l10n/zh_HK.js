OC.L10N.register(
    ...
    "{appDisplayName} would like permission to access your account. It is a third party application." : "{appDisplayName} 想要存取您帳戶的權限。它是第三方應用程式。",
    ...
    "Hello" : "嗨",
    "Please confirm that you want to follow this account:" : "請確認您要關注此帳戶：",
    "You are following this account" : "您正在關注此帳戶",
    "Close" : "關閉",
    "You are going to follow:" : "您將要關注：",
    "name@domain of your federation account" : "您聯盟帳戶的 name@domain",
    "Continue" : "繼續",
    ...
    "Since you are new to Social, start by following the official Nextcloud account so you don't miss any news" : "鑑於您剛來到 Social，請先關注 Nextcloud 官方帳戶，這樣您將不會錯過任何新聞",
