OC.L10N.register(
    ...
    "boosted" : "geteilt",
    "{account} mentioned you" : "{account} hat dich erwähnt",
    "{account} posted a status" : "{account} hat einen Status gepostet",
    "{account} boosted your post" : "{account} hat deinen Beitrag geboostet",
    "{account} started to follow you" : "{account} folgt Ihnen jetzt",
    "{account} requested to follow you" : "{account} möchte dir folgen",
    "{account} liked your post" : "{account} gefällt dein Beitrag",
    "{account} ended the poll" : "{account} hat die Umfrage beendet",
    "{account} edited a status" : "{account} hat einen Status bearbeitet",
    "{account} signed up" : "{account} hat sich angemeldet",
    "{account} filed a report" : "{account} hat einen Bericht erstellt",
