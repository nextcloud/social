...
- 🧭 **Timelines** — Home, Local, Global (federated), Direct messages, Liked posts, Notifications, per-account and per-hashtag timelines. The three a reader moves between all day — **My Feed**, **Local** and **Global** — also sit above the posts as a switcher, because changing between them is something you do while reading rather than somewhere you navigate to; they keep their sidebar entries too.
